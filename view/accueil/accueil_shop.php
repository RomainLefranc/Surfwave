      ...
      <div class="bloc boutique">
         ...
         <div class="row">
            <div class="produit col-lg-4 col-md-12">
               <img src="media/planchedesurf.jpg" alt="Planche de surf" class="img-fluid">

      ...
      <div class="container">
         <div class="bloc partenaires">
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
               ...
               <div class="carousel-inner">
                  <div class="carousel-item active">
                     <img class="d-block w-100" src="media/slider_1.jpg" alt="First slide">
                  </div>
                  <div class="carousel-item">
                     <img class="d-block w-100" src="media/slider_2.jpg" alt="Second slide">
                  </div>
                  <div class="carousel-item">
                     <img class="d-block w-100" src="media/slider_3.jpg" alt="Third slide">
                  </div>
                  <div class="carousel-item">
                     <img class="d-block w-100" src="media/slider_4.jpg" alt="Third slide">
                  </div>
               </div>
            ...
            <div class="row bloc-partner">
               <div class="col-lg-6"><img src="media/hebergements.jpg" alt="Hébergements" class="img-fluid"></div>
               <div class="col-lg-6">
                  <h3>Hébergements</h3>
            ...
            <div class="row bloc-partner">
               <div class="col-lg-6 d-block d-lg-none"><img src="media/restauration.jpg" alt="Restauration" class="img-fluid"></div>
               <div class="col-lg-6">
                  <h3>Restauration</h3>
               ...
               <div class="col-lg-6 d-none d-lg-block"><img src="media/restauration.jpg" alt="Restauration" class="img-fluid"></div>
            </div>
            <div class="row bloc-partner">
               <div class="col-lg-6"><img src="media/activites.jpg" alt="Activites" class="img-fluid"></div>
               <div class="col-lg-6">
